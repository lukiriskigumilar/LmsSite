...
import SsoBtn from "../atoms/sso_button";

function AuthBtn({ onclickBtnFunc, text_btn, image_sso, txt_sso, onclickSsoFunc }) {
    return (
        <>
            <GenralBtn className={"bg-green-primary-100 mt-[10px] text-green-primary text-[16px] font-[700] w-full text-center block rounded-full py-[10px]"} onClickFunc={onclickBtnFunc} txtBtn={text_btn} />
