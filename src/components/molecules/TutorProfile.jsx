        ...
        <>
            <div className="flex gap-3 mt-[10px]">
                ...
                <div className="flex flex-col justify-center">
                    <h4 className="font-semibold text-[16px] font-family-dm-sans line-clamp-3">{tutorName}</h4>
                    <p className="text-[12px] text-text-secondary font-family-dm-sans line-clamp-2">{tutorJob}
