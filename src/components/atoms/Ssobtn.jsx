function SsoBtn({image_sso, txt_sso, onclickSsoFunc}) {
    return (
        ...
        className="mt-[20px] mb-[20px] flex items-center justify-center text-center gap-2 px-4 py-2 bg-transparent border border-gray-300 text-white w-full rounded-full">
